...
| Session/security CTest and reference utility | Deterministic UDS `0x10`/`0x27` state, NRC, reset, timing, callback integration, and repository-generated key vectors | Production cryptography, vendor HAL behavior, or physical timing |
