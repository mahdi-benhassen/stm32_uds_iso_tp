...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1A00_TPDOMappingParameter = {
        ...
        .applicationObject1 = 0x60600120,
        .applicationObject2 = 0x60100110,
        .applicationObject3 = 0x60810108,
        .applicationObject4 = 0x00000000,
        .applicationObject5 = 0x00000000,
        .applicationObject6 = 0x00000000,
        .applicationObject7 = 0x00000000,
...
OD_ATTR_APP OD_APP_t OD_APP = {
    ...
    .x6020_batteryParameters = { .highestSub_indexSupported = 4,
        .batteryType = 0,
        .ahCapacity = 0,
        .maximumChargeCurrent = 0,
        .numberOfCells = 0
    },
    .x6030_batterySerialNumber = { 3, 0 },
    .x6031_batteryId = { 5, 0 },
    .x6040_vehicleSerialNumber = { 5, 0 },
    .x6041_vehicleId = { 5, 0 },
    .x6054_dateOfLastEqualization = { 2, 0 },
};
...
typedef struct {
    ...
    OD_obj_var_t o_6000_batteryStatus;
    OD_obj_var_t o_6001_chargerStatus;
    OD_obj_var_t o_6010_temperature;
    OD_obj_var_t o_6050_cumulativeTotalAhCharge;
    OD_obj_var_t o_6051_ahExpendedSinceLastCharge;
    OD_obj_var_t o_6052_ahReturnedDuringLastCharge;
    OD_obj_var_t o_6053_ahSinceLastEqualization;
    OD_obj_var_t o_6060_batteryVoltage;
    OD_obj_var_t o_6070_chargeCurrentRequested;
    OD_obj_var_t o_6080_chargerStateOfCharge;
    OD_obj_var_t o_6081_batteryStateOfCharge;
    OD_obj_var_t o_6090_waterLevelStatus;
    OD_obj_record_t o_6020_batteryParameters[5];
    OD_obj_array_t o_6030_batterySerialNumber;
    OD_obj_array_t o_6031_batteryId;
    OD_obj_array_t o_6040_vehicleSerialNumber;
    OD_obj_array_t o_6041_vehicleId;
    OD_obj_array_t o_6054_dateOfLastEqualization;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6000_batteryStatus = {
        .dataOrig = &OD_APP.x6000_batteryStatus,
        .attribute = ODA_SDO_R | ODA_TPDO,
        .dataLength = 1
    },
    .o_6001_chargerStatus = {
        .dataOrig = &OD_APP.x6001_chargerStatus,
        .attribute = ODA_SDO_RW,
        .dataLength = 1
    },
    .o_6010_temperature = {
        .dataOrig = &OD_APP.x6010_temperature,
        .attribute = ODA_SDO_R | ODA_MB | ODA_TPDO,
        .dataLength = 2
    },
    .o_6050_cumulativeTotalAhCharge = {
        .dataOrig = &OD_APP.x6050_cumulativeTotalAhCharge,
        .attribute = ODA_SDO_R | ODA_MB,
        .dataLength = 4
    },
    .o_6051_ahExpendedSinceLastCharge = {
        .dataOrig = &OD_APP.x6051_ahExpendedSinceLastCharge,
        .attribute = ODA_SDO_R | ODA_MB,
        .dataLength = 2
    },
    .o_6052_ahReturnedDuringLastCharge = {
        .dataOrig = &OD_APP.x6052_ahReturnedDuringLastCharge,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 2
    },
    .o_6053_ahSinceLastEqualization = {
        .dataOrig = &OD_APP.x6053_ahSinceLastEqualization,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 2
    },
    .o_6060_batteryVoltage = {
        .dataOrig = &OD_APP.x6060_batteryVoltage,
        .attribute = ODA_SDO_R | ODA_MB | ODA_TPDO,
        .dataLength = 4
    },
    .o_6070_chargeCurrentRequested = {
        .dataOrig = &OD_APP.x6070_chargeCurrentRequested,
        .attribute = ODA_SDO_R | ODA_MB | ODA_TPDO,
        .dataLength = 2
    },
    .o_6080_chargerStateOfCharge = {
        .dataOrig = &OD_APP.x6080_chargerStateOfCharge,
        .attribute = ODA_SDO_RW,
        .dataLength = 1
    },
    .o_6081_batteryStateOfCharge = {
        .dataOrig = &OD_APP.x6081_batteryStateOfCharge,
        .attribute = ODA_SDO_R | ODA_TPDO,
        .dataLength = 1
    },
    .o_6090_waterLevelStatus = {
        .dataOrig = &OD_APP.x6090_waterLevelStatus,
        .attribute = ODA_SDO_R,
        .dataLength = 1
    },
    .o_6020_batteryParameters = {
        {
            .dataOrig = &OD_APP.x6020_batteryParameters.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_APP.x6020_batteryParameters.batteryType,
            .subIndex = 1,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_APP.x6020_batteryParameters.ahCapacity,
            .subIndex = 2,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_APP.x6020_batteryParameters.maximumChargeCurrent,
            .subIndex = 3,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_APP.x6020_batteryParameters.numberOfCells,
            .subIndex = 4,
            .attribute = ODA_SDO_R | ODA_MB,
            .dataLength = 2
        }
    },
    .o_6030_batterySerialNumber = {
        .dataOrig0 = (uint8_t*) &OD_APP.x6030_batterySerialNumber[0],
        .dataOrig = &OD_APP.x6030_batterySerialNumber[1],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_R | ODA_MB,
        .dataElementLength = 4,
        .dataElementSizeof = sizeof(uint32_t)
    ...
    .o_6031_batteryId = {
        .dataOrig0 = (uint8_t*) &OD_APP.x6031_batteryId[0],
        .dataOrig = &OD_APP.x6031_batteryId[1],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_R | ODA_MB,
        .dataElementLength = 4,
        .dataElementSizeof = sizeof(uint32_t)
    },
    .o_6040_vehicleSerialNumber = {
        .dataOrig0 = (uint8_t*) &OD_APP.x6040_vehicleSerialNumber[0],
        .dataOrig = &OD_APP.x6040_vehicleSerialNumber[1],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_R | ODA_MB,
        .dataElementLength = 4,
        .dataElementSizeof = sizeof(uint32_t)
    ...
    .o_6041_vehicleId = {
        .dataOrig0 = (uint8_t*) &OD_APP.x6041_vehicleId[0],
        .dataOrig = &OD_APP.x6041_vehicleId[1],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_R | ODA_MB,
        .dataElementLength = 4,
        .dataElementSizeof = sizeof(uint32_t)
    },
    .o_6054_dateOfLastEqualization = {
        .dataOrig0 = (uint8_t*) &OD_APP.x6054_dateOfLastEqualization[0],
        .dataOrig = &OD_APP.x6054_dateOfLastEqualization[1],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataElementLength = 2,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6000, 0x01, ODT_VAR, &ODObjs.o_6000_batteryStatus, NULL},
    {0x6001, 0x01, ODT_VAR, &ODObjs.o_6001_chargerStatus, NULL},
    {0x6010, 0x01, ODT_VAR, &ODObjs.o_6010_temperature, NULL},
    {0x6020, 0x05, ODT_REC, &ODObjs.o_6020_batteryParameters, NULL},
    {0x6030, 0x04, ODT_ARR, &ODObjs.o_6030_batterySerialNumber, NULL},
    {0x6031, 0x06, ODT_ARR, &ODObjs.o_6031_batteryId, NULL},
    {0x6040, 0x06, ODT_ARR, &ODObjs.o_6040_vehicleSerialNumber, NULL},
    {0x6041, 0x06, ODT_ARR, &ODObjs.o_6041_vehicleId, NULL},
    {0x6050, 0x01, ODT_VAR, &ODObjs.o_6050_cumulativeTotalAhCharge, NULL},
    {0x6051, 0x01, ODT_VAR, &ODObjs.o_6051_ahExpendedSinceLastCharge, NULL},
    {0x6052, 0x01, ODT_VAR, &ODObjs.o_6052_ahReturnedDuringLastCharge, NULL},
    {0x6053, 0x01, ODT_VAR, &ODObjs.o_6053_ahSinceLastEqualization, NULL},
    {0x6054, 0x03, ODT_ARR, &ODObjs.o_6054_dateOfLastEqualization, NULL},
    {0x6060, 0x01, ODT_VAR, &ODObjs.o_6060_batteryVoltage, NULL},
    {0x6070, 0x01, ODT_VAR, &ODObjs.o_6070_chargeCurrentRequested, NULL},
    {0x6080, 0x01, ODT_VAR, &ODObjs.o_6080_chargerStateOfCharge, NULL},
    {0x6081, 0x01, ODT_VAR, &ODObjs.o_6081_batteryStateOfCharge, NULL},
    {0x6090, 0x01, ODT_VAR, &ODObjs.o_6090_waterLevelStatus, NULL},
