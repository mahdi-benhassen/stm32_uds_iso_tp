...
def main() -> int:
    ...
    transport_init_pos = main_c.find("uds_c092_fdcan_transport_init")
    ...
    if not (0 <= transport_init_pos < app_init_pos < notification_pos < start_pos):
        errors.append("transport/ISO-TP/UDS initialization must precede RX notification and FDCAN Start")
